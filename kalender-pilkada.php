    ...
    <div class="container pt-120 pb-70">
        <header>
            ...
            <div class="row d-none d-sm-flex p-1 bg-dark text-white">
                ...
                <h5 class="col-sm p-1 text-center text-white">Selasa</h5>
                <h5 class="col-sm p-1 text-center text-white">Rabu</h5>
                <h5 class="col-sm p-1 text-center text-white">Kamis</h5>
                <h5 class="col-sm p-1 text-center text-white">Jumat</h5>
                <h5 class="col-sm p-1 text-center text-white">Sabtu</h5>
            </div>
        </header>
        <div class="row border border-right-0 border-bottom-0">
            <div
                ...
                <h5 class="row align-items-center">
                    ...
                    <small class="col d-sm-none text-center text-muted">Minggu</small>
            ...
            <div
                ...
                <h5 class="row align-items-center">
                    ...
                    <small class="col d-sm-none text-center text-muted">Senin</small>
                    <span class="col-1"></span>
                </h5>
                <p class="d-sm-none">No events</p>
            </div>
            <div
                ...
                <h5 class="row align-items-center">
                    ...
                    <small class="col d-sm-none text-center text-muted">Selasa</small>
                    <span class="col-1"></span>
                </h5>
                <p class="d-sm-none">No events</p>
            </div>
            <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
                <h5 class="row align-items-center">
                    ...
                    <small class="col d-sm-none text-center text-muted">Rabu</small>
                    <span class="col-1"></span>
                </h5>
                <p class="d-sm-none">No events</p>
            </div>
            <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
                <h5 class="row align-items-center">
                    ...
                    <small class="col d-sm-none text-center text-muted">Kamis</small>
                    <span class="col-1"></span>
                </h5>
                <p class="d-sm-none">No events</p>
            </div>
            <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
                <h5 class="row align-items-center">
                    ...
                    <small class="col d-sm-none text-center text-muted">Jumat</small>
                    <span class="col-1"></span>
                </h5>
            ...
            <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
                <h5 class="row align-items-center">
                    ...
                    <small class="col d-sm-none text-center text-muted">Sabtu</small>
                    <span class="col-1"></span>
                </h5>
                <p class="d-sm-none">No events</p>
            </div>
            ...
            <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
                ...
                <!-- <a class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-success text-white"
                    title="Test Event 2">Test Event 2</a> -->
                <a class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-danger text-white"
                    title="Test Event 3">Pilkada Serentak 2020</a>
            </div>
            <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
                <h5 class="row align-items-center">
            ...
            <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
                ...
                <!-- <a class="event d-block p-1 pl-2 pr-2 mb-1 rounded text-truncate small bg-primary text-white"
                    title="Test Event with Super Duper Really Long Title">Test Event with Super Duper Really Long
                    Title</a> -->
            </div>
            <div class="day col-sm p-2 border border-left-0 border-top-0 text-truncate ">
                <h5 class="row align-items-center">
