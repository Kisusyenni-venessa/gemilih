                    ...
                    <div class="post-details-cover">
                        ...
                        <div class="post-thumb-cover">
                            ...
                            <div class="post-meta-info">
                                ...
                                <!-- Title -->
                                <div class="title">
                                    <h2>Gugus Tugas Covid-19 Batam Teken MoU dengan KPU</h2>
                                </div>
                                <!-- Meta -->
                                <ul class="nav meta align-items-center">
                                    <li class="meta-author">
                                        <img src="assets/images/news-img/author/metrobatam.png" alt=""
                                            class="img-fluid" data-rjs="2">
                                        <a href="https://www.metrobatam.com/">Metro Batam</a>
                                    </li>
                                    <li class="meta-date"><a href="news-6.php">Kamis, 9 July 2020 16:09 WIB</a></li>
                                    <li> 2 min read </li>
                                </ul>
                            </div>
                            <!-- End of Post Meta Info -->
                            <div class="post-thumb">
                                <img src="assets/images/news-img/news6.jpg" alt="" class="img-fluid" data-rjs="2">
                            </div>
                        </div>
                        ...
                        <div class="post-content-cover my-drop-cap">
                            <blockquote>
                                <p>Metrobatam.com, Batam – Gugus Tugas Percepatan Penanganan Covid-19 Kota Batam menandatangani kerjasama dengan Komisi Pemilihan Umum (KPU) terkait dengan penerapan protokol kesehatan saat pemilihan kepala daerah (Pilkada) serentak Desember 2020 mendatang.
                                </p>
